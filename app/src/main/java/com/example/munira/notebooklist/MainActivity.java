...
public class MainActivity extends AppCompatActivity {
    ...
    private Button addPossibleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     /*   menuIncome=(TextView) findViewById(R.id.total_income_title);
        ...
        addPossibleButton = (Button) findViewById(R.id.possible_button);
        addYearlyButton = (Button) findViewById(R.id.yearly_button);
        ...
        // Possible Capture button clicks
        addPossibleButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,Possible_list.class);
                startActivity(intent);
            }
        });

        // Yearly Capture button clicks
        addYearlyButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MainActivity.this,Yearly_list.class);
                startActivity(intent);
            }
        });
